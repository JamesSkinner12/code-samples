...
use App\Repositories\PerformanceIndicatorsRepository;
...
class StorePerformanceIndicatorsCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'application:kpi';
     ...
     *
     * @param  \App\Repositories\PerformanceIndicatorsRepository  $indicators
     * @return mixed
     */
